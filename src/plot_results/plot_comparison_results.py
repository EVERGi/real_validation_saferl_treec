...
def plot_experiment_simulation(result_dir="data/results/"):
    log_folder = f"{result_dir}experiment_simulation/"
    log_perfect = f"{result_dir}perfect_mpc/"
    plot_comparison_results(
        log_folder,
        log_perfect=log_perfect,
        plot_all_comparison=True,
        only_paper_plots=True,
    )


def plot_house_3_tree_improvement(result_dir="data/results/"):

    log_folder = f"{result_dir}replace_batt_rbc_house3/"
