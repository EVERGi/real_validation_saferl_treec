...
def plot_critic_loss(result_dir):
    # Replace 'path/to/logs' with your TensorBoard log directory
    log_dir = f"{result_dir}tensorboard/"
...
def plot_actor_loss(result_dir):
...
def plot_tensorboard_logs(result_dir="data/results/"):
    plot_actor_loss(result_dir)
    plot_critic_loss(result_dir)
